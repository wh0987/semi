    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-xs-center">
                <h3 class="mbr-section-title display-2">VISIT US</h3>
...
<section class="mbr-section mbr-section__container" id="map2-4i" style="background-color: rgb(239, 239, 239); padding-top: 120px; padding-bottom: 120px;">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <h3 class="lead " style="margin-bottom: 1.8125rem" >

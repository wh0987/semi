<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.sql.*, data_source.*" %>
<%
	String idlog = (String) session.getAttribute("idKey");
%>
                    ...
                    <div class="mbr-table-cell">
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                <% if(idlog != null) {%>
                                    <tl style="color:#84ff84"><%=idlog %>님 반갑습니다.</tl>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-xs-center">
                <h3 class="mbr-section-title display-2">관리자 페이지</h3>
                    ...
                    <div class="mbr-table-md-up">
                        <div class="mbr-table-cell col-md-5 text-xs-center text-md-left content-size">
                            <div class="mbr-section-text lead">
                                <h3 class="lead ">회원관리</h3>
                                    <br><br>
                                    <table style="font-size:15px; border:1px solid #E1FDFF; border-top:1px solid #E1FDFF; border-top: lightskyblue;" class="table">
                                        <tr style="background-color: #E1FDFF;" >
                                            <td width=200px>id</td>
                                            <td width=200px>name</td>
                                            <td width=300px>birth</td>
                                            <td width=200px>phonenum</td>
...
//                                                    password = rs.getString("password");
                                ...
                                <div style="text-align: right;">
                                    ...
                                    %>
                                    <form method="post" name="adfrm" action="userdel.jsp" style=" margin-top: 20px;">
                                        <input type="text" name="iddel" id="iddel" value="id를 입력하시오." onFocus="clearText(this)" onBlur="clearText(this)">
